          ...
          <div class="card shadow">
            <div class="card-header border-0">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="" name="up_dept" value="<?php echo $row['department'];?>">
                  	</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="inputGroupFile01"
                       name="updeptfile" value="<?php echo $row['bg_link'];?>">
                ...
                <div class="modal-footer">
					...
					<button type="submit" class="btn btn-outline-primary" name="update_department">Update</button>
			      </div>
                 </form>
