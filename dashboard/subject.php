            ...
            <div class="card-header border-0">
                ...
                <!-- Table -->
                 ...
                 ?>
                   ...
                   <form method="POST" action="verify.php" enctype="multipart/form-data">
                    ...
                    <input class="form-control" placeholder="" type="hidden" name="dept_id" value="<?php echo $dept;?>">

                     <input class="form-control" placeholder="" type="hidden" name="deptname" value="<?php echo $r['department'];?>">
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <textarea class="form-control" placeholder="Reference..." name="subject_ref" required=""></textarea> 
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-file">
                      ...
                      <label class="custom-file-label" for="inputGroupFile01">Choose Subject Image</label>
                    </div>
                ...
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                         <button type="submit" class="btn btn-outline-primary" name="addsubject">Add</button>
                  </div>
                  </form>
                </div>
              </div>
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <form action="update_subject.php" method="POST">
                            <input type="hidden" name="updatesub" value="<?php echo $row['subject'];?>">
                              <!-- Button trigger modal -->
                            ...
                            <input type="text" name="delsub" value="<?php echo $row['subject'];?>">
