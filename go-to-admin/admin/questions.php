            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Aptitute</h5>
          ...
          <div class="card shadow">
            <div class="card-header border-0">
                ...
                <!-- Table -->
                   ...
                   <select id="department" onChange="getsubject(this.value)" name="dept" required="" class="form-control input-group input-group-alternative mb-3" >
                    ...
                    <select id="subject" name="subject" required="" class="form-control input-group input-group-alternative mb-3" >
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                   ...
                   <select name="q_type" required="" class="form-control input-group input-group-alternative mb-3" >
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <form action="question_update.php" method="POST">
                            <textarea name="q_name" style="display: none;" value="<?php echo $row['question'];?>"><?php echo $row['question'];?></textarea>
                              <!-- Button trigger modal -->
                              <button type="submit" class="dropdown-item" name="updateq">
                              <i class="ni ni-fat-add">&nbsp;</i>Update 
                             </button>
                           </form>

                              <form action="verify.php" method="POST">
                            <input type="hidden" name="delq" value="<?php echo $row['question'];?>">
                          <button type="submit" class="dropdown-item" name="deleteq">
