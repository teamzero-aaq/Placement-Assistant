            ...
            <div class="card-header border-0">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="" type="password" name="uppassadmin" value="<?php echo $row['password'];?>" disabled>
                  </div>
                </div>
                <div class="modal-footer">
 				...
 				<?php 
				  ...
				  echo $_SESSION['status'];
				   	   ?>
				   	 <a href="index.php"><button type="button" class="btn btn-secondary" data-dismiss="modal">Back</button></a>	<?php 
