...
while($rows=mysqli_fetch_array($result))
 { ?>
        <li class="list-group-item list-group-item-action"><i class="far fa-folder-open mx-2"></i><a href="forum.php?id=<?php echo $rows['id']; ?>"><?php echo str_replace("-"," ",ucfirst(($rows['question']))); ?></a></li>
         <?php
       }
       ?>
      </ul>
