...
for ($i=2; $i <count($file) ; $i++) { 
	?>
 <li class="list-group-item list-group-item-action"><i class="far fa-folder-open mx-2"></i><a href="viewquestions.php?name=<?php  echo str_replace(".txt"," ", $file[$i]);?>"><?php echo str_replace(".txt"," ",str_replace("-"," ",ucfirst(($file[$i])))); ?></a></li>
